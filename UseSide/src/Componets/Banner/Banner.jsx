    ...
    return (
        <div className="relative w-full h-[600px] bg-white overflow-hidden mt-[58px]">
            ...
            <div className="relative z-10 h-full flex flex-col justify-center px-6 sm:px-12 text-white">
                ...
                <h1 className="text-3xl sm:text-5xl font-bold text-center">Find Amazing products below</h1>
                <div className="flex justify-center w-[100%] pt-3">
                    <button className=" items-center mt-4 bg-white border border-transparent hover:border-white text-black hover:text-white hover:bg-red-500 font-semibold px-5 py-2 rounded shadow flex w-[100px] transition">
                        Scroll
